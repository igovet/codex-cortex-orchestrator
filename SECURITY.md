...
This repository contains the Cortex 10.0.2 Codex plugin. The runtime is
...
package manifest is version 10.0.2 and the ledger schema is v15.
...
Before publishing 10.0.2 or a later release:
