...
This repository contains the Cortex 10.0.3 Codex plugin. The runtime is
...
package manifest is version 10.0.3 and the ledger schema is v15.
...
Before publishing 10.0.3 or a later release:
