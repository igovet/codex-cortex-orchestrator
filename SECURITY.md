...
Security fixes are prepared for the current `1.0.1` source line. Older task
and lane schemas are not supported by a compatibility reader and must be
recreated as `cortex/v7` records.
