...
def test_cortex_v12_plugin_is_publishable_and_nonblocking(tmp_path: Path) -> None:
    ...
    for marker in (
        ...
        "task-creation operation is the only operation that receives the canonical absolute project root",
    ...
    for marker in (
        "Only the task-creation operation accepts the user-selected canonical project root.",
