<table>
  <tr>
    ...
    <td valign="middle">
      ...
      <p>
        <img src="https://img.shields.io/badge/Cortex-10.0.2-7c3aed" alt="Cortex 10.0.2" />
...
### 10.0.2 canonical AttemptResult and AttemptEvent protocol

Cortex 10.0.2 uses one database-centric worker protocol. A worker checkpoints
...
### 10.0.2 ContextCompiler and HandoffCompiler boundaries
...
### 10.0.2 same-attempt finalization and recovery
...
### 10.0.2 public API and audience boundary
...
### 10.0.2 Prompt Contract v3 and dispatch authority
...
### 10.0.2 governance, security, and verification
