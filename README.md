<table>
  <tr>
    ...
    <td valign="middle">
      ...
      <p>
        <img src="https://img.shields.io/badge/Cortex-9.2.8-7c3aed" alt="Cortex 9.2.8" />
...
### 9.2.8 recovery and disaster-recovery hardening release
...
`target_met: true`. The exact 9.2.8 cachebuster and full release/live results
