<table>
  <tr>
    ...
    <td valign="middle">
      ...
      <p>
        <img src="https://img.shields.io/badge/Cortex-10.0.5-7c3aed" alt="Cortex 10.0.5" />
...
### 10.0.5 canonical AttemptResult and AttemptEvent protocol

Cortex 10.0.5 uses one database-centric worker protocol. A worker checkpoints
...
### 10.0.5 ContextCompiler and HandoffCompiler boundaries
...
### 10.0.5 same-attempt finalization and recovery
...
### 10.0.5 public API and audience boundary
...
### 10.0.5 Prompt Contract v3 and dispatch authority
...
### 10.0.5 governance, security, and verification
