<table>
  <tr>
    ...
    <td valign="middle">
      ...
      <p>
        <img src="https://img.shields.io/badge/Cortex-10.0.1-7c3aed" alt="Cortex 10.0.1" />
...
### 10.0.1 canonical AttemptResult and AttemptEvent protocol

Cortex 10.0.1 uses one database-centric worker protocol. A worker checkpoints
...
### 10.0.1 ContextCompiler and HandoffCompiler boundaries
...
### 10.0.1 same-attempt finalization and recovery
...
### 10.0.1 public API and audience boundary
...
### 10.0.1 Prompt Contract v3 and dispatch authority
...
### 10.0.1 governance, security, and verification
