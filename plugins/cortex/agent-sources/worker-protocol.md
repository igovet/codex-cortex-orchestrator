...
Choose a class matching the observed outcome; default is `{{Default report template}}`.
...
Use `{{Default report template}}` unless another ordinary report class better
