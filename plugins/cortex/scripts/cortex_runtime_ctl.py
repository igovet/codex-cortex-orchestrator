...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--provider", action="store_true", help="connect the verified gateway while configuring")
    ...
    if args.command == "configure":
        ...
        try:
            ...
            if provider_settings is not None:
                provider_result = GatewaySupervisor(codex_home=effective_home).connect()
