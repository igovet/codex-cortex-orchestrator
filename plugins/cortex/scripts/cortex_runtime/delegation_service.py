...
def rehydrate_dispatch_spawn_request(
    ...
    request["message"] = host_spawn_bootstrap(
        ...
        str(attempt.get("worker_capability") or ""),
...
def record_delegation(params: dict[str, Any]) -> dict[str, Any]:
    ...
    with state_lock(root):
        ...
        state["attempts"][-1]["worker_capability"] = worker_capability
        state["attempts"][-1]["worker_capability_digest"] = worker_capability_digest
