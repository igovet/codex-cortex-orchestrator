        ...
        "read_reports": {
            ...
            "inputSchema": _closed({
                ...
                "cursor": _string(maximum=2_048),
                    ...
                    "reader_kind": _string(enum=("worker", "coordinator"), maximum=16, description="Worker reads require the exact consuming delegation; a missing reader_kind is classified as coordinator."),
                }, ("report_refs",)),
