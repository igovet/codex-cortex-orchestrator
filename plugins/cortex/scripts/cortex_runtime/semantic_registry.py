...
_ERROR_SPECS: tuple[ErrorSpec, ...] = (
    ...
    ErrorSpec("outcome_item_not_found", "The semantic outcome is not in the effective contract.", "Copy the complete semantic outcome from the current read_task result."),
    ...
    ErrorSpec("plan_clarification_required", "The selected plan contains unresolved decisions and cannot be presented as a generic approval choice.", "Open a clarification for the unresolved product or policy choice, record the explicit answer, then obtain a revised plan with no unresolved decision before approval."),
)
...
_SPECS: tuple[OperationSpec, ...] = (
    ...
    OperationSpec("open_clarification", "command", ("clarification", "decision-identity"), "open_clarification", "open_clarification", ("pending_decision",), ("task_ref",), logical_slot="decision.pending.clarification", handler_name="open_clarification", safe_errors=("task_not_found", "command_conflict", "clarification_binding_stale")),
    OperationSpec("record_clarification", "command", ("clarification", "decision-transaction"), "record_clarification", "record_clarification", ("decision_recorded",), ("task_ref",), logical_slot="decision.consumed", handler_name="record_clarification", safe_errors=("clarification_binding_not_found", "clarification_binding_stale", "clarification_binding_conflict", "clarification_binding_consumed", "command_conflict")),
    OperationSpec("open_plan_review", "command", ("plan-approval", "decision-identity"), "open_plan_review", "open_plan_review", ("pending_decision",), ("task_ref",), logical_slot="decision.pending.plan_review", handler_name="open_plan_review", safe_errors=("task_not_found", "approval_view_required", "approval_view_not_ready", "plan_clarification_required", "command_conflict")),
    ...
    OperationSpec("open_assignment", "command", ("worker-dispatch", "server-owned-routing", "dispatch-correlation", "dag", "ownership", "model-routing"), "open_assignment", "open_assignment", ("native_dispatch",), ("task_ref", "semantic_outcomes", "report_policy"), logical_slot="assignment.intent", handler_name="open_assignment", safe_errors=("task_not_found", "profile_unavailable", "outcome_item_not_found", "outcome_item_stale", "outcome_assignment_conflict", "dispatch_lease_active", "command_conflict")),
    OperationSpec("publish_plan", "command", ("planning", "publication-completeness", "contract-coverage"), "publish_plan", "publish_plan", ("publication_state",), ("task_ref", "semantic_evidence"), logical_slot="publication.plan", handler_name="publish_plan", safe_errors=("report_incomplete", "publication_conflict")),
    OperationSpec("publish_result", "command", ("implementation", "verification", "publication-completeness", "atomic-publication"), "publish_result", "publish_result", ("publication_state",), ("task_ref", "semantic_evidence"), logical_slot="publication.result", handler_name="publish_result", safe_errors=("report_incomplete", "publication_conflict")),
    OperationSpec("publish_documentation", "command", ("documentation-impact", "documentation-sync", "publication-completeness", "atomic-publication"), "publish_documentation", "publish_documentation", ("publication_state",), ("task_ref", "semantic_evidence"), logical_slot="publication.documentation", handler_name="publish_documentation", safe_errors=("report_incomplete", "publication_conflict")),
    ...
    OperationSpec("close_task", "command", ("closure", "follow-ups", "unresolved-risks"), "close_task", "close_task", ("closure_state",), ("task_ref",), logical_slot="task.closure", handler_name="close_task", safe_errors=("closure_not_ready", "task_not_found")),
)
