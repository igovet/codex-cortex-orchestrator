...
_ERROR_SPECS: tuple[ErrorSpec, ...] = (
    ...
    ErrorSpec("closure_review_required", "A current explicit user result review is required before task closure.", "Present the current verified result and ask the user to choose revision of this same task or task closure through the advertised closure-review decision."),
