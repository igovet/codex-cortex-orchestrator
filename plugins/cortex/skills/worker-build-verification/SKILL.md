---
name: worker-build-verification
description: "Cortex delegated specialist only: Build and test verifier for exact command outcomes and release-readiness proof."
---

This complete skill has 535 lines. A successful range read that stops earlier is incomplete. Before discovery or project work, read through the final standalone completion marker; use a full-file read or continue the remaining ranges.
