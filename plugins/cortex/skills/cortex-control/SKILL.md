---
name: cortex-control
description: Internal Cortex v1.15.0 task_ref-only semantic companion supplied after explicit cortex:orchestrator activation.
---
