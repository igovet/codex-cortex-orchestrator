...
description: "Cortex delegated specialist only: Codebase investigator for execution paths, ownership, dependencies, and relevant files."
---

This complete skill has 532 lines. A successful range read that stops earlier is incomplete. Before discovery or project work, read through the final standalone completion marker; use a full-file read or continue the remaining ranges.
