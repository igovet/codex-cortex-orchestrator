---
name: worker-security-auditor
description: "Cortex delegated specialist only: Security auditor for authentication, authorization, secrets, cryptography, dependencies, and data-protection risks."
---

This complete skill has 529 lines. A successful range read that stops earlier is incomplete. Before discovery or project work, read through the final standalone completion marker; use a full-file read or continue the remaining ranges.
...
Your profile's report template is `verification`. Call `create_draft`
