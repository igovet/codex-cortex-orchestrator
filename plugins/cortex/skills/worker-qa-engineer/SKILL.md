---
name: worker-qa-engineer
description: "Cortex delegated specialist only: QA specialist for acceptance coverage, automated tests, reproduction scenarios, and quality-risk evidence."
---

This complete skill has 534 lines. A successful range read that stops earlier is incomplete. Before discovery or project work, read through the final standalone completion marker; use a full-file read or continue the remaining ranges.
