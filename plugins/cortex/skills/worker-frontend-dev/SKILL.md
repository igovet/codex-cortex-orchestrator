...
This complete skill has 537 lines. A successful range read that stops earlier is incomplete. Before discovery or project work, read through the final standalone completion marker; use a full-file read or continue the remaining ranges.
