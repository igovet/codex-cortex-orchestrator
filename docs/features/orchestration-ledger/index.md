...
The local MCP server implements the Cortex 9.2.8 `cortex/v8` task ledger plus
...
The 9.2.8 hardening release candidate. The cold-boot smoke uses the public JSON-RPC server to reject
