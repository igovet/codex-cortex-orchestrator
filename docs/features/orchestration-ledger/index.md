...
The local MCP server implements the Cortex 9.2.13 `cortex/v8` task ledger plus
...
9.2.13 hardening release candidate. The cold-boot smoke uses the public JSON-RPC server to reject
