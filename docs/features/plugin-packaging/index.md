...
The current source manifest and server declare plugin version `4.4.3`; the
local registration is installed and content-verified as
`4.4.3+codex.20260815231023`.
