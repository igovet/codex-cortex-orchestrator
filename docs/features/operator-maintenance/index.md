...
Cortex 1.15.0 includes a local administrator CLI for explicit maintenance of
...
twenty-tool MCP registry; rejects malformed/cross-shard task anchors, unsafe
