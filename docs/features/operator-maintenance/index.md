...
Cortex 1.14.10 includes a local administrator CLI for explicit maintenance of
...
fourteen-tool MCP registry; rejects malformed/cross-shard task anchors, unsafe
