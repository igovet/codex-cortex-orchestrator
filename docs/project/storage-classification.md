...
| Closure statements | `governance_closures` | `close_task`; `read_task` evidence view | Immutable advisory task verdict and evidence; does not establish or rewrite user-work execution outcome |
