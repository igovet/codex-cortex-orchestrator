...
candidate. They do not certify the 9.2.10 hardening release candidate above;
...
The source manifest now declares the 9.2.10 source cachebuster. Historical
...
## 9.2.10 release-candidate evidence status

This section describes the hardening work visible in the source tree. The
source cachebuster is generated from the 9.2.10 base version.
...
## Current 9.2.10 source contract
