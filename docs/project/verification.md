...
This page describes Cortex 1.14.14 source, package, installed-host, and
...
must be `1.14.14+codex.sha256.<digest-prefix>` and its suffix must match the
...
successful `initialize`, report semantic version `1.14.14` with
...
- V12/1.14.14/schema-v1 identifiers;
