...
def lint_skills(issues: list[str], tools_from_runtime: list[str]) -> dict[str, Any]:
    ...
    require_concepts(
        ...
        ORCHESTRATOR,
        "non-empty task/result contract before create_task",
        (
            ("Before `create_task`", "Before that call"),
            ("non-empty arrays", "must each contain meaningful English content"),
            ("requirements",),
            ("constraints",),
            ("acceptance",),
            ("verification",),
    ...
    require_concepts(
        ...
        (
            ...
            ("initiative",),
            ("exact task",),
            ("finalized report IDs", "every finalized report"),
            ("task relationship",),
            ("report-only final initiative",),
    ...
    overlay_rules = (
        (
            ...
            (("one complete question",), ("end the turn",), ("Silence",),
             ("exact response",), ("live handle",), ("parent_delegation_id",),
